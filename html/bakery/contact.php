    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-12 m-bottom3">
          <h4 class="font-black font20">About Company</h4>
        ...
        <div class="col-md-3 col-sm-12 m-bottom3">
          <h4 class="font-black font20">Recent Posts</h4>
          <div class="title-line color"></div>
          <div class="c-post">
            ...
            <div class="c-post-content">
              ...
              <p class="c-text">Lorem ipsum dolor sit dolor<br>
        ...
        <div class="col-md-3 col-sm-12 m-bottom3">
          <h4 class="font-black font20">Twitter Feed!</h4>
          <div class="title-line color"></div>
        ...
        <div class="col-md-3 col-sm-12 m-bottom3">
          <h4 class="font-black font20">Flickr Photos</h4>
          <div class="title-line color"></div>
